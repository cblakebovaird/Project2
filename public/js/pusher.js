...
(function() {
    ...
    var serverUrl = "/",
        comments = [],
        pusher = new Pusher('59443b3a88eb29a1348c', {
          cluster: 'us2',
          encrypted: true
        }),
    ...
    function newCommentReceived(data){
      var newCommentHtml = commentTemplate.innerHTML.replace('part1',data.name);
      newCommentHtml = newCommentHtml.replace('part2',data.email);
      newCommentHtml = newCommentHtml.replace('part3',data.comment);
